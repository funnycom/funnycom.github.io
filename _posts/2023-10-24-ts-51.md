...
# Part 3 실전 프로젝트: TypeScript 작업 관리 시스템

## 🎯 프로젝트 개요

Part 3에서 배운 고급 TypeScript 기능들을 모두 활용하여 **작업 관리 시스템(Task Management System)**을 만들어봅시다.
...
// 생성 시 사용할 DTO (id, timestamp 제외)
export type CreateUserDto = Omit<User, 'id' | 'createdAt' | 'updatedAt'>;

// 업데이트 시 사용할 DTO (일부만 수정 가능)
...
프로젝트가 길어서 여기서 중간 체크를 하겠습니다. 

계속해서 다음 내용을 작성할까요?
- Step 6: Service 계층 (비즈니스 로직 + 데코레이터 활용)
- Step 7: 메인 애플리케이션
- Step 8: 테스트 시나리오
- Step 9: 실행 및 테스트
